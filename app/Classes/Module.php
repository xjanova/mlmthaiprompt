...
class Module
{
    ...
    {
        $path = base_path('addon/' . $name . '/module.json');
        if (!File::exists($path)) {
            return false;
        }
            ...
            function () use ($name) {
                if ($name === 'general') {
                    ...
                    if ($addonJson) {
                        ...
                        $this->image = url('/addon/' . $addonJson['name'] . '/favicon.png');
                    ...
                    if ($this->addon) {
                        ...
                        $this->image = !empty($this->addon->image) ? get_file($this->addon->image) : url('/addon/' . $this->addon->module . '/favicon.png');
    ...
    public function getPath()
    {
        ...
        return base_path('addon/' . $this->name);
    }
