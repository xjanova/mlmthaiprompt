...
class ModuleController extends Controller
{
        ...
        if (Auth::user()->isAbleTo('module manage')) {
            try {
                ...
                foreach($devPackages as $devPackage){
                    ...
                    $devModules[$index]['image'] = url('/addon/' . $devPackage . '/favicon.png');
    ...
    public function enable(Request $request)
    {
        ...
        if (!empty($module)) {
            ...
            if ($module->isEnabled()) {
                ...
                if (empty($addon)) {
                    Artisan::call('migrate --path=/addon/' . $request->name . '/src/Database/Migrations');
                    Artisan::call('package:seed ' . $request->name);

                    $filePath = base_path('addon/' . $request->name . '/module.json');
    ...
    public function install(Request $request)
    {
        ...
        $filePath = base_path('addon/' . $fileName . '/module.json');
