        ...
        <div class="row mt-3">
            <div class="col-md-6 col-12">
                ...
                <div class="card p-4 mb-4">
                    ...
                    <h6 class="report-text mb-0 mt-1">{{__('Account Statement Summary')}}</h6>
                </div>
            </div>
            @if($filter['account']!=__('All'))
                <div class="col-md-6 col-12">
                    <div class="card p-4 mb-4">
                        ...
                        <h6 class="report-text mb-0 mt-1">{{$filter['account']}}</h6>
                    </div>
                </div>
            @endif
            @if($filter['type']!=__('All'))
                <div class="col-md-6 col-12">
                    <div class="card p-4 mb-4">
                        ...
                        <h6 class="report-text mb-0 mt-1">{{$filter['type']}}</h6>
                    </div>
                </div>
            @endif
            <div class="col-md-6 col-12">
