...
@push('scripts')
    ...
    <script>
        (function() {
            ...
            var formattedProfit = {!! json_encode($profit) !!}.map(function(value) {
                                ...
                                <div class="row">
                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                        <div class="btn-box">
                                            ...
                                            {{ Form::select('year', $yearList, isset($_GET['year']) ? $_GET['year'] : date('Y'), ['class' => 'form-control ']) }}
                                        </div>
                                    </div>
                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                        <div class="btn-box">
        ...
        <div class="row mt-3">
            <div class="col">
                ...
                <div class="card p-4 mb-4">
                    ...
                    <h6 class="report-text mb-0 mt-1">{{ __('Income Vs Expense Summary') }}</h6>
                </div>
            </div>
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{ __('Purchase') }}</td>
                                        @foreach ($purchaseExpenseTotal as $purchase)
                                    ...
                                    @if (module_is_active('Hrm'))
                                        <tr>
                                            ...
                                            @foreach ($EmpSalary as $empsalary)
                                                <td>{{ currency_format_with_sym($empsalary) }}</td>
                                            @endforeach
                                        </tr>
                                    @endif
                                    @if (module_is_active('Training'))
                                        <tr>
                                            ...
                                            @foreach ($TrainingCost as $trainingcost)
