...
@endsection
@push('scripts')
    <script src="{{ asset('addon/Account/src/Resources/assets/js/html2pdf.bundle.min.js') }}"></script>
    <script>
                            ...
                            <div class="col-xl-10">
                                <div class="row">
                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                        ...
                                        {{Form::month('start_month',isset($_GET['start_month'])?$_GET['start_month']: date('Y-m'),array('class'=>'month-btn form-control','placeholder'=>'Start Month'))}}
                                        </div>
                                    </div>
                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                        <div class="btn-box">
                                        {{ Form::label('end_month', __('End Month'), ['class' => 'form-label']) }}
                                        {{Form::month('end_month',isset($_GET['end_month'])?$_GET['end_month']:date('Y-m'),array('class'=>'month-btn form-control','placeholder'=>'Start Month'))}}
                                        </div>
                                    </div>
                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                        <div class="btn-box">
                            ...
                            <tbody>
                                @foreach ($transactions as $transaction)
                                    <tr>
                                        ...
                                        <td>
                                            @if(!empty($transaction) && $transaction->holder_name=='Cash')
                                                {{$transaction->holder_name}}
                                            @else
                                                {{!empty($transaction)?$transaction->bank_name.' '.$transaction->holder_name:'-'}}
                                            @endif
                                        </td>
