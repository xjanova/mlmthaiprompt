                    ...
                    <div class="col-1  text-end">
                        @permission('taskstage manage')
                            <button data-repeater-create type="button"
                                class="btn-submit btn btn-sm btn-primary btn-icon " data-bs-toggle="tooltip"
                                title="{{ __('Add') }}">
                        ...
                        <tbody>
                            <tr data-repeater-item>
                                ...
                                <td>
                                    ...
                                    <input type="text" name="name" class="form-control mb-0" placeholder="Enter Name"
...
@push('scripts')
    <script src="{{ asset('addon/Taskly/src/Resources/assets/js/jquery-ui.min.js')}}"></script>
    <script src="{{ asset('addon/Taskly/src/Resources/assets/js/repeater.js')}}"></script>
    <script src="{{ asset('addon/Taskly/src/Resources/assets/js/colorPick.js')}}"></script>
