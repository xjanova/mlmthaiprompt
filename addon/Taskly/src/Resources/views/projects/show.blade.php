...
@push('css')
    ...
    <link rel="stylesheet" href="{{ asset('addon/Taskly/src/Resources/assets/css/custom.css') }}" type="text/css" />
@endpush
                    ...
                    <div class="dashboard-project-card">
                        <div class="card-inner  d-flex justify-content-between">
                            <div class="card-content">
                                ...
                                <h3 class="mt-3 mb-0 text-danger">{{ __('Total Tasks') }}</h3>
                            </div>
                        ...
                        <div class="dashboard-project-card">
                            <div class="card-inner  d-flex justify-content-between">
                                <div class="card-content">
                                    ...
                                    <h3 class="mt-3 mb-0">{{ __('Days left') }}</h3>
                                </div>
                                    ...
                                    <tbody>
                                        @foreach ($project->milestones as $key => $milestone)
                                            <tr>
                                                ...
                                                <td>{{ currency_format_with_sym($milestone->cost) }}
                                                </td>
                                                <td>
...
@push('scripts')
    ...
    <script src="{{ asset('addon/Taskly/src/Resources/assets/js/dropzone.min.js') }}"></script>
    <script>
