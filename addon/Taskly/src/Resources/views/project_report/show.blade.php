...
@push('css')
    <link rel="stylesheet" href="{{ asset('addon/Taskly/src/Resources/assets/css/datatables.min.css') }}">
    <link rel="stylesheet" href="{{ asset('addon/Taskly/src/Resources/assets/css/custom.css') }}">
    <style type="text/css">
...
@push('scripts')
    ...
    <script src="{{ asset('addon/Taskly/src/Resources/assets/js/jquery.dataTables.min.js') }}"></script>
    <script src="{{ asset('addon/Taskly/src/Resources/assets/js/apexcharts.min.js') }}"></script>
