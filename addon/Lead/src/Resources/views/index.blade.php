...
@push('css')
    <link rel="stylesheet" href="{{ asset('addon/Lead/src/Resources/assets/css/main.css') }}" />
@endpush
...
@push('scripts')
    <script src="{{ asset('addon/Lead/src/Resources/assets/js/main.min.js') }}"></script>
...
@push('css')
    <link rel="stylesheet" href="{{ asset('addon/Lead/src/Resources/assets/css/custom.css') }}">
@endpush
@section('content')
