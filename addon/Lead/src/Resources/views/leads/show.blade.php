...
@push('css')
    ...
    <link rel="stylesheet" href="{{ asset('addon/Lead/src/Resources/assets/css/dropzone.min.css') }}">
@endpush
...
@push('scripts')
    ...
    <script src="{{ asset('addon/Lead/src/Resources/assets/js/dropzone.min.js') }}"></script>
                                                    ...
                                                    @if ($key % 3 === 2)
                                                        ...
                                                        <div class="ms-2">
                                                            ...
                                                            @if ($field->type == 'attachment')
                                                                <a href="{{ !empty($lead->customField[$field->id]) ? get_file($lead->customField[$field->id]) : get_file('addon/Lead/src/Resources/assets/upload/default-img.png') }}"
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    ...
                                                                    if (check_file($product->image) == false) {
                                                                        $path = asset('addon/ProductService/src/Resources/assets/image/img01.jpg');
                                                                    } else {
