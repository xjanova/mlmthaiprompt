...
@php
    $path = url("/addon/Stripe/src/marketplace");
@endphp
@section('page-title')
    {{ __('Software Details') }}
@endsection
    ...
    <section class="dedicated-themes-section padding-bottom">
        <div class="container">
            <div class="section-title text-center">
                <h2>{{__('Stripe')}}<b>{{__('Payment')}}</b>{{__('Gateway')}}</h2>
                <p>{{__('Stripe is an online payment processing and credit card processing platform for businesses. ')}}</p>
            </div>
                ...
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            ...
                            <h2>{{__('Why use Stripe payment?')}}</h2>
                        </div>
                        <p>{{__('Stripe Payments is a powerful payment processor for online sales. It can accept dozens of payment methods and more than 135 currencies. And its advanced developer tools allow you to create a checkout flow that feels custom, provided you know how to use them.')}}</p>
                    </div>
                </div>
                            ...
                            <div class="tabs-container">
                                <div class="tab-content active" id="tab-1">
                                    <div class="pricing-content">
                                        ...
                                        <div class="lbl">{{__('Billed monthly, or')}} <b>{{ super_currency_format_with_sym($module->yearly_price).'/' }}</b>{{__(' if paid monthly')}}</div>
                                        <div class="btn-group">
