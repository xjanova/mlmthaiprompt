...
class PosController extends Controller
{
            ...
            if (count($products)>0)
            {
                foreach ($products as $key => $product)
                {
                    ...
                    if(check_file($product->image)){
                        ...
                        $image_url =asset('addon/ProductService/src/Resources/assets/image/img01.jpg');
                    }
    ...
    public function addToCart(Request $request, $id,$session_key,$war)
    {
        if (Auth::user()->isAbleTo('pos cart manage') && $request->ajax()) {
            ...
            $image_url = (check_file($product->image) && get_file($product->image)) ? $product->image : asset('addon/ProductService/src/Resources/assets/image/img01.jpg');
