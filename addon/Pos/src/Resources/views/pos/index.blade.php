...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('addon/Pos/src/Resources/assets/css/site.css') }}" id="stylesheet">
    ...
    <link rel="stylesheet" href="{{ asset('addon/Pos/src/Resources/assets/css/custom.css') }}" id="main-style-link">
    <style>
...
<body class="{{ isset($themeColor) ? $themeColor : 'theme-1' }}">
                                        ...
                                        @if (session($lastsegment) && !empty(session($lastsegment)) && count(session($lastsegment)) > 0)
                                            ...
                                            @if (in_array($details['id'], $ids))
                                                @php
                                                    ...
                                                    $image_url = !empty($product) && check_file($product->image) && get_file($product->image) ? $product->image : asset('addon/ProductService/src/Resources/assets/image/img01.jpg');
    ...
    <script src="{{ asset('addon/Pos/src/Resources/assets/js/moment.min.js') }}"></script>
    ...
    <script src="{{ asset('addon/Pos/src/Resources/assets/js/jscolor.js') }}"></script>
    <script src="{{ asset('addon/Pos/src/Resources/assets/js/custom.js') }}"></script>
