...
<script src="{{ asset('addon/Pos/src/Resources/assets/js/jquery-barcode.min.js') }}"></script>
<script src="{{ asset('addon/Pos/src/Resources/assets/js/jquery-barcode.js') }}"></script>
<script>
