@php
    ...
    @endpush
    @push('scripts')
        <script src="{{ asset('addon/LandingPage/src/Resources/assets/js/jquery.qrcode.js') }}"></script>
        <script src="{{ asset('addon/LandingPage/src/Resources/assets/js/jquery.qrcode.min.js') }}"></script>
        <script src="{{ asset('addon/LandingPage/src/Resources/assets/js/socialSharing.js') }}"></script>
        <script src="{{ asset('addon/LandingPage/src/Resources/assets/js/socialSharing.min.js') }}"></script>
