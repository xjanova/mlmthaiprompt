        ...
        @include('landingpage::marketplace.modules')
                <div class="row">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                ...
                                <div id="p1" class="col-auto text-end text-primary h3">
                                    <a image-url="{{ asset('addon/LandingPage/src/Resources/assets/infoimages/whychoose.png') }}"
                        ...
                        {{ Form::open(array('route' => array('whychoose_store',$slug), 'method'=>'post', 'enctype' => "multipart/form-data",'class'=>'needs-validation', 'novalidate')) }}
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12">
                                    ...
                                    <div class="row" >
                                        ...
                                        <div class="border" >
                                            <div class="row py-3 border-bottom">
                                                ...
                                                <div class="col-auto text-end">
                                                    ...
                                                    data-bs-toggle="tooltip"  title="{{__('Plan Features')}}"
                                            ...
                                            @foreach (json_decode($settings['pricing_plan_text'] ,true) as $key => $title)
                                                <div id="{{ 'add-cards'.$key }}" class="border-bottom row py-2">
                                                    ...
                                                    <div class="col-md-2 d-flex text-center align-items-center">
                                                        <a href="#" id="{{ 'delete-card'.$key }}" class="card-delete btn btn-danger btn-sm bs-pass-para" data-bs-toggle="tooltip"  title="{{__('Delete')}}" data-title="{{__('Delete')}}" data-original-title="{{__('Delete')}}">
                                        ...
                                        @else
                                            <div id="add-cards1" class="border-bottom row py-2">
                                                ...
                                                <div class="col-md-2 d-flex text-center align-items-center">
                                                    <a href="#" id="{{ 'delete-card1' }}" class="card-delete btn btn-danger btn-sm bs-pass-para" title="{{__('Delete')}}" data-bs-toggle="tooltip"  data-title="{{__('Delete')}}" data-original-title="{{__('Delete')}}">
                                                        <i class="ti ti-trash text-white"></i>
                                                    </a>
                                                </div>
                                            </div>
