                        ...
                        <div class="card-header">
                            <div class="row align-items-center">
                                ...
                                <div id="p1" class="col-auto text-end text-primary h3">
                                    <a image-url="{{ asset('addon/LandingPage/src/Resources/assets/infoimages/screenshots.png') }}"
                                ...
                                <div class="col-auto justify-content-end d-flex">
                                    <a data-size="mx" data-url="{{ route('marketplace_screenshots_create',$slug) }}" data-ajax-popup="true"  data-bs-toggle="tooltip" title="{{__('Create')}}" data-title="{{__('Create Screenshots ')}}"  class="btn btn-sm btn-primary">
                                                    ...
                                                    <td>
                                                        <span>
                                                            <div class="action-btn  me-2">
                                                                    <a href="#" class="bg-info btn btn-sm align-items-center" data-url="{{ route('marketplace_screenshots_edit',[$slug , $key]) }}" data-ajax-popup="true" data-title="{{__('Edit Screenshots')}}" data-size="mx" data-bs-toggle="tooltip"  title="{{__('Edit')}}" data-original-title="{{__('Edit')}}">
