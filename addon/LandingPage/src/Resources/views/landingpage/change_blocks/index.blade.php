...
@push('scripts')
    ...
    <script src="{{ asset('addon/LandingPage/src/Resources/assets/js/repeater.js') }}"></script>
    <script src="{{ asset('addon/LandingPage/src/Resources/assets/js/colorPick.js') }}"></script>
    <script src="{{ asset('addon/LandingPage/src/Resources/assets/js/Sortable.min.js') }}"></script>
