<div class="card">
    ...
    <div class="card-body">
        <div class="border">
            {{ Form::open(array('route' => 'footer_store', 'method'=>'post', 'enctype' => "multipart/form-data" , 'class'=>'needs-validation', 'novalidate' )) }}
                    <div class="border-bottom p-3 accordion-header">
                        <div class="row align-items-center">
                            ...
                            <div id="p1" class="col-auto text-end text-primary h3">
                                <a image-url="{{ asset('addon/LandingPage/src/Resources/assets/infoimages/footersection.png') }}"
        ...
        <div class="border mt-5">
            <div class="border-bottom p-3 accordion-header">
                <div class="row align-items-center">
                    ...
                    <div id="p1" class="col-auto text-end text-primary h3">
                        <a image-url="{{ asset('addon/LandingPage/src/Resources/assets/infoimages/footersection.png') }}" data-id="1"
                           data-url="{{ route('info.image.view',['landingpage','footer']) }}" class="view-images pt-2">
                            <i class="ti ti-info-circle pointer"></i>
                        </a>
                    </div>
                                        ...
                                        <td>
                                            <span>
                                                <div class="action-btn  me-2">
                                                        <a href="#" class="bg-info btn btn-sm align-items-center" data-url="{{ route('footer_section_edit',$key) }}" data-ajax-popup="true" data-title="{{__('Edit Page')}}" data-size="lg" data-bs-toggle="tooltip"  title="{{__('Edit')}}" data-original-title="{{__('Edit')}}">
